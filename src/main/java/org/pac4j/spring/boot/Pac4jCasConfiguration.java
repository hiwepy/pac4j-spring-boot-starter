...
public class Pac4jCasConfiguration {
	...
	public CasConfiguration casConfiguration(
			...
			ObjectProvider<UrlResolver> urlResolverProvider,
		...
		map.from(logoutHandlerProvider.getIfAvailable()).to(configuration::setLogoutHandler);
		...
		map.from(proxyReceptorProvider.getIfAvailable()).to(configuration::setProxyReceptor);
		...
		map.from(urlResolverProvider.getIfAvailable()).to(configuration::setUrlResolver);
