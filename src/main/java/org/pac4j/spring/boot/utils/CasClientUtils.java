...
public class CasClientUtils {
	...
	public static DirectCasClient directCasClient(CasConfiguration configuration,Pac4jCasProperties casProperties) {
	...
	public static DirectCasProxyClient directCasProxyClient(CasConfiguration configuration,Pac4jCasProperties casProperties, String serverUrl) {
	...
	public static CasRestBasicAuthClient casRestBasicAuthClient(CasConfiguration configuration,Pac4jCasProperties casProperties) {
	 ...
	 * @return
	 */
	public static CasRestFormClient casRestFormClient(CasConfiguration configuration,Pac4jCasProperties casProperties) {
